...
//        TopIP topIP = new TopIP();
//
//        TreeMap<String, Integer> returnedMap = topIP.findTopIP(new File(this.getClass().getResource("testFile1").getFile()), sqlHelper);
//
...
//        TopIP topIP = new TopIP();
//
//        TreeMap<String, Integer> returnedMap = topIP.findTopIP(new File(this.getClass().getResource("testFile2").getFile()), sqlHelper);
//
...
//        TopIP topIP = new TopIP();
//
//        TreeMap<String, Integer> returnedMap = topIP.findTopIP(new File(this.getClass().getResource("testFile3").getFile()), sqlHelper);
//
//        assertThat(returnedMap.firstKey(), is("255.240.230.3"));
